...
export default function CategoryCard({
  ...
  return (
    <Link
      ...
      className="group relative flex flex-col bg-[#eff6ff] border border-gray-200 rounded-lg hover:shadow-md transition-shadow h-[140px] overflow-hidden will-change-shadow"
    >
      {/* ИКОНКА */}
      {iconUrl && (
